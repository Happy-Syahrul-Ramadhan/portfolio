    ...
    <div className="flex flex-col gap-6">
      <div className="admin-page-header">
        ...
        <Link
          ...
          className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90"
        >
